/*
  ...
  - The values [OPENED_LID] on the enum `Stage` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "Stage_new" AS ENUM ('INITIALIZED', 'OPEN_LID', 'SHOW_COC', 'ACCEPTED_COC', 'FINISHED');
